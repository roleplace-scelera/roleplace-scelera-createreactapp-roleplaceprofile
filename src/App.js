        ...
        <div className="App">
            <header className="App-header">
                ...
                <p>
                    ...
                    <code>
                        git clone
                        https://github.com/roleplace-scelera/roleplace-scelera-createreactapp-roleplaceprofile.git <br/>
                    </code>
                    cd to the new project repo (the folder with the package.json) then just run: <br/>
                    <code>
                        yarn install <br/>
                        yarn start <br/>
                    </code>
